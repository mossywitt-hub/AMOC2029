...
introTop: [
  "The Atlantic meridional overturning circulation (AMOC) regulates the weather that keeps half the planet alive. By 2029 it was slowing faster than anyone had predicted.[amoc-annex]",
...
whyWeWrote: [
  ...
  "Critically, as we depict, the outcomes that remain achievable are not just not bad, but better than the present. They may not be as dramatic as AI futurism but they are more substantive and more definite: cleaner, quieter towns and cities; politics free from energy crises and price shocks; generations that don’t have to live out fundamental anxiety about the future (or at least, not climate-related anxiety).",
...
scenes: [
  {
    ...
    body:[
      ...
      "One bullet from the Policy Implications summary caught Miriam’s eye. It began: Once a slowdown takes hold, flooding and blackouts could quickly incapacitate hospitals in coastal cities.",
      {divider:true},
